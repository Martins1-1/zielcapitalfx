      ...
      <main className="flex-grow">
        ...
        <section className="bg-gradient-to-r from-primary to-blue-700 text-white py-16">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">About ZielCapitalFX</h1>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 items-center">
              ...
              <p className="text-lg text-gray-700 mb-4">
                ZielCapitalFX is one of the fastest-growing online trading brands in the world. We are committed to providing our clients with access to global capital markets through cutting-edge technology and competitive pricing.
              </p>
              ...
              <div className="order-1 md:order-2">
                <img src="/slider-img/in-cirro-slide-2.jpg" alt="About ZielCapitalFX" className="rounded-xl shadow-lg" />
              </div>
            </div>
          </div>
        </section>
