      ...
      <main className="flex-grow">
        ...
        <section className="bg-primary text-white py-12">
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-6">
            <img src="/other-img/logoicon1.png" alt="ZielCapitalFX logo" className="h-14 w-14 mb-4 md:mb-0 md:mr-6 rounded-full bg-white p-2 shadow-2xl" />
            <div className="flex-1 flex flex-col items-start justify-center max-w-xl">
              <h3 className="text-xl font-bold mb-2">Why ZielCapitalFX is a trusted broker</h3>
              <p className="text-base opacity-90">ZielCapitalFX gives you privilege and access to invest in a wide range of stocks, ETFs, commodities and cryptocurrencies, with safer access to long term and short term plans.</p>
            </div>
        ...
        <section className="bg-gradient-to-r from-info to-cyan-600 text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 opacity-90">Join thousands of investors who trust ZielCapitalFX</p>
