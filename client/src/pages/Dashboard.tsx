...
const Dashboard = ({ setIsAuthenticated }: DashboardProps): JSX.Element => {
  ...
  const investmentPlans = [
    { name: 'Starter Plan', type: 'fixed', minAmount: 50, maxAmount: 1999, duration: '1 day', roi: 6 },
    ...
    { name: 'Yop Plan', type: 'fixed', minAmount: 50000, maxAmount: 100000, duration: '1 day', roi: 40 },
