          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="card p-6">
                ...
                <p className="text-gray-600 mb-3">Read the Terms of Service and License Agreement for ZielCapitalFX as well as our ZielCapitalFX & Developer Agreements.</p>
              ...
              <div className="card p-6">
                ...
                <p className="text-gray-600 mb-3">Find out more about what information we collect at ZielCapitalFX, how we use it, and what control you have over your data.</p>
          ...
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <div className="space-y-4">
              ...
              <details className="card p-4">
                ...
                <p className="text-gray-700 mt-2">if ZielCapitalFX.com starts having long load times we advice yo clear your browser history and cache, as most times is the cause of slow pages. Or better still get a better network.</p>
              </details>
              <details className="card p-4">
                <summary className="font-semibold cursor-pointer">Can my company request a custom plan?</summary>
                <p className="text-gray-700 mt-2">At ZielCapitalFX our investors are at our best intrest and yes your company can request for a new plan if the available doesnt suite you. On the condition that the agreement is to be made between the admins and your company.</p>
              </details>
            </div>
          </div>
        </section>
