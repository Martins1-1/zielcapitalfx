                ...
                <div className="px-4 pb-4 border-t pt-4">
                  <div className="prose max-w-none">
                    ...
                    <p className="text-gray-700 mb-4">
                      By accessing and using ZielCapitalFX platform, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
                    </p>
                    
                    <h3 className="text-xl font-bold mb-4">2. Use License</h3>
                    <p className="text-gray-700 mb-4">
                      Permission is granted to temporarily access the materials (information or software) on ZielCapitalFX's platform for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
                    </p>
                    <ul className="list-disc pl-6 mb-4 text-gray-700">
                      <li>Modify or copy the materials</li>
                      <li>Use the materials for any commercial purpose or for any public display</li>
                      <li>Attempt to reverse engineer any software contained on ZielCapitalFX's platform</li>
                    ...
                    <p className="text-gray-700 mb-4">
                      ZielCapitalFX provides trading services for various financial instruments including forex, stocks, cryptocurrencies, and commodities. All trades are subject to market conditions and platform availability.
                    </p>

                    <h3 className="text-xl font-bold mb-4">5. Limitation of Liability</h3>
                    <p className="text-gray-700 mb-4">
                      In no event shall ZielCapitalFX or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on ZielCapitalFX's platform.
                    </p>
                  </div>
                </div>
              )}
              ...
              {expandedSection === 'aml' && (
                <div className="px-4 pb-4 border-t pt-4">
                  <div className="prose max-w-none">
                    ...
                    <p className="text-gray-700 mb-4">
                      ZielCapitalFX is committed to preventing money laundering and terrorist financing. We comply with all applicable anti-money laundering (AML) and counter-terrorist financing (CTF) laws and regulations.
                    </p>
